    ...
    <div className="min-h-screen bg-gradient-to-bl from-gray-600 to-gray-950 text-white">
      ...
      >
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-primary to-secondary rounded-full blur-lg opacity-75" />
          <Image
            src={banner.image}
                ...
                <CardFooter className="flex justify-between items-center">
                  <div className="flex gap-2">
                    {item.contributions.map((tech, techIndex) => (
                      <span key={techIndex} className="text-xs bg-primary text-primary-foreground px-2 py-1 rounded">
                        {tech}
                      </span>
                    ))}
                  </div>
